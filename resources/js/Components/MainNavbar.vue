        ...
        <nav aria-label="Top" class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="border-b border-gray-200">
                <div class="flex h-16 items-center">
                    ...
                    <!-- Flyout menus -->
                    <PopoverGroup
                        class="hidden lg:ml-8 lg:block lg:self-stretch shadow-sm z-50"
                    >
            ...
            sections: [
                {
                    ...
                    name: "Clothing",
                    items: [
                        { name: "Tops", href: "/men/category" },
                        { name: "Dresses", href: "/men/category" },
                        { name: "Pants", href: "/men/category" },
                        { name: "Denim", href: "/men/category" },
                        { name: "Sweaters", href: "/men/category" },
                        { name: "T-Shirts", href: "/men/category" },
                        { name: "Jackets", href: "/men/category" },
                        { name: "Activewear", href: "/men/category" },
                        { name: "Browse All", href: "/men/category" },
                    ],
                },
                {
                    id: "accessories",
